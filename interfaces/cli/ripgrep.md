...
- [GUIDE](#guide)
  - [User Guide](#user-guide)
    ...
    - [Manual filtering: file types](#manual-filtering-file-types)
      - [The special `all` file type](#the-special-all-file-type)
    - [Replacements](#replacements)
    - [Configuration file](#configuration-file)
    - [File encoding](#file-encoding)
    - [Binary data](#binary-data)
    - [Preprocessor](#preprocessor)
      - [A more robust preprocessor](#a-more-robust-preprocessor)
      - [Reducing preprocessor overhead](#reducing-preprocessor-overhead)
