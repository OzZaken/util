...
function sortByStr(objArr: { name: string }[]): void {
    objArr.sort((student1, student2) => student1.name.localeCompare(student2.name));
}
...
console.group('sort methods')
console.time('methodSort'),methodSort(_getNums()),console.timeEnd('methodSort')
console.time('simpleSort'),simpleSort(_getNums()),console.timeEnd('simpleSort')
console.time('bubbleSort'),bubbleSort(_getNums()),console.timeEnd('bubbleSort')
console.time('mergeSort'),mergeSort(_getNums()),console.timeEnd('mergeSort')
console.time('insertionSort'),insertionSort(_getNums()),console.timeEnd('insertionSort')
console.time('selectionSort'),selectionSort(_getNums()),console.timeEnd('selectionSort')
console.time('quickSort'),quickSort(_getNums()),console.timeEnd('quickSort')
console.time('heapSort'),heapSort(_getNums()),console.timeEnd('heapSort')
console.groupEnd()
